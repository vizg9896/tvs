...
export const VEHICLES: Vehicle[] = [
  ...
  },
  {
    id: 'orbiter',
    title: 'TVS Orbiter',
    subtitle: 'Smart Urban Sustainable EV',
    image: '/assets/tvs_orbiter.png',
    price: 99900,
    speed: '68 km/h',
    power: '2.5 kW',
    acceleration: '6.8s (0-40)',
    category: 'Scooter',
    isEV: true,
    desc: 'The all-new smart everyday electric scooter. TVS Orbiter is designed for sustainable urban commuting with a 3.1 kWh battery, certified range of 158 km, sleek front visor with LED headlamp, and coloured LCD console.',
    colorways: [
    ...
    specs: {
      'Engine & Transmission': 'Electric Hub Motor with 1.8 kWh / 3.1 kWh high-safety Lithium-ion battery packs',
      'Power & Torque': '2.5 kW peak power & certified IDC range of up to 158 km per charge',
      'Suspension Setup': 'Telescopic front forks & dual hydraulic rear shock absorbers',
      'Braking & Safety': 'Front disc and rear drum brakes with Synchronized Braking Technology',
      'Smart Dashboard & Console': 'Coloured LCD console with app connectivity, call display, and turn-by-turn navigation'
    },
    variants: [
      { name: 'Orbiter V1 (1.8 kWh)', price: 84500, desc: 'Entry-level model with 86 km certified range' },
      { name: 'Orbiter V2 (3.1 kWh)', price: 99900, desc: 'Flagship model with 158 km certified range' }
    ]
  },
